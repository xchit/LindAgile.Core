...
namespace LindAgile.Core.Domain
{
    ...
    public struct PrimaryKey : IComparable<PrimaryKey>, IEquatable<PrimaryKey>
    {
        ...
        private static PrimaryKey __emptyInstance = default(PrimaryKey);
        ...
        public PrimaryKey(DateTime timestamp, int machine, short pid, int increment)
        ...
        /// <param name="pid">The PID.</param>
        /// <param name="increment">The increment.</param>
        public PrimaryKey(int timestamp, int machine, short pid, int increment)
        {
        ...
        public static PrimaryKey GenerateNewId()
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static PrimaryKey GenerateNewId(DateTime timestamp)
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static PrimaryKey GenerateNewId(int timestamp)
        {
            int increment = Interlocked.Increment(ref __staticIncrement) & 0x00ffffff; // only use low order 3 bytes
            return new PrimaryKey(timestamp, __staticMachine, __staticPid, increment);
        }
        ...
        public static PrimaryKey Parse(string s)
        {
            if (s == null)
            {
            ...
            return new PrimaryKey(ParseHexString(s));
        }
